    ...
    return(
      <View style={{flex:1
        ...
        <View style={{flex:0.15,
          ...
          <Text style={{color:'white', fontSize:25,fontWeight:'bold',paddingTop:40}}>
            Gallery
          </Text>

          <View style={{backgroundColor:'white',flex:0.8,width:80,justifyContent:'center',alignItems:'center',borderRadius:10}}>
            <Text>
              7/16 Votes
            </Text>
          </View>
