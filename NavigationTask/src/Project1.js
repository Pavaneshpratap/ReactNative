        ...
        return (
            <ScrollView>
                <View style={{ flex: 1, backgroundColor: 'lightgrey' }}>
                    <View style={{
                        flex: 0.2, flexDirection: 'row', borderLeftWidth: 2, borderRightWidth: 2, borderBottomWidth: 2, backgroundColor: '#342'
                    }}>
                        <Image
...
const styles = StyleSheet.create({
    ...
    View: {
        marginTop: 10, marginLeft: 10, alignItems: 'center', backgroundColor: 'black',
