        ...
        <View style={{flex:1,backgroundColor:'lightgrey'}}> 
            ...
            <View>
                <View style={{marginLeft:12,marginTop:10}}>
                    <View style={{backgroundColor:'#342',borderColor:'black',borderWidth:2,shadowColor:'black',shadowRadius:10,shadowOpacity:0.2,flexDirection:'row',justifyContent:'space-between',borderRadius:20,height:170,width:350}}>
                   ...
                   <View style={{marginLeft:10,marginTop:40,backgroundColor:'#342',borderColor:'black',borderWidth:2,shadowColor:'black',shadowRadius:10,shadowOpacity:0.2,flexDirection:'row',justifyContent:'space-between',borderRadius:20,height:170,width:350}}>
                        <View style={styles.View}>
                            <Image 
                            style={{height:90,width:90,borderRadius:15,borderColor:'black',borderWidth:3}}
                ...
                <Text style={{fontSize:15,paddingTop:10,paddingRight:15}}>
                    ...
                    <View style={{marginLeft:10,marginTop:10,backgroundColor:'#342',borderColor:'black',borderWidth:2,shadowColor:'black',shadowRadius:10,shadowOpacity:0.2,flexDirection:'row',justifyContent:'space-between',borderRadius:20,height:170,width:350}}>
                        <View style={styles.View}>
                            <Image 
                            style={{height:90,width:90,borderRadius:15,borderColor:'black',borderWidth:3}}
                    ...
                    <View style={{marginLeft:10,marginTop:50,backgroundColor:'#342',borderColor:'black',borderWidth:2,shadowColor:'black',shadowRadius:10,shadowOpacity:0.2,flexDirection:'row',justifyContent:'space-between',borderRadius:20,height:170,width:350}}>
                        <View style={styles.View}>
                            <Image 
                            style={{height:90,width:90,borderRadius:15,borderColor:'black',borderWidth:3}}
